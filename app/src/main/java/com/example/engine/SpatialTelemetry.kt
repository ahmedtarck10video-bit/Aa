...
data class TelemetryState(
  ...
  val isGpuDepthTextureUploaded: Boolean = false,
  val isShaderFragmentDiscardActive: Boolean = false,
  val isCpuAnalyticalOcclusionActive: Boolean = true,
  val gpuOcclusionPipelineMode: String = "CPU_ANALYTICAL",
  val cameraStreamStatus: String = "CAMERA_STREAM_ACTIVE",
